...
var Visibility = function() {
	...
	/** @member {Array of Segment} */
	this.segments = [];
	/** @member {Array of EndPoint} */
	this.endpoints = [];
	/** @member {Point} */
	...
	/** @member {Array of Point} */
	this.output = [];

	// For the demo, keep track of wall intersections
	/** @member {Array of Array of Point} */
...
Visibility.prototype = {
	 ...
	 * @param size
	 * @param margin
	 * @param {Array of Block} blocks
	 * @param {Array of Segment} walls
	 * @public
	 */
